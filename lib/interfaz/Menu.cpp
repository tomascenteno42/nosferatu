...
//     cout << ALTA << ". "
//          << "Agregar un nuevo personaje u objeto en una posición determinada.  " << endl;
//     cout << BAJA << ". "
//          << "Eliminar un personaje u objeto." << endl;
//     cout << MOSTRAR_TABLERO << ". "
//          << "Mostrar el tablero." << endl;
//     cout << BUSCAR_POR_CUADRANTE << ". "
//          << "Buscar por cuadrante un personaje u objeto." << endl;
//     cout << BUSCAR_POR_ID << ". "
//          << "Buscar por ID los detalles de un personaje u objeto en particular." << endl;
//     cout << "0. "
...
//         {
//             Objeto *objeto = this->tablero->getElementoEnPosicion(i, j);
...
//         }
//         else
//             cout << "Los ids son numeros, ingrese nuevamente" << endl;

//     } while (!this->esUnNumero(texto));

//     this->getTablero()->getDiccionario()->getData(id);
// }
...
//         break;
//     case (NORESTE):/         pos_max = Posicion(this->tablero->cantidadFilas(), this->tablero->cantidadColumnas() / 2);
//         break;
//     case (SUROESTE):
...
//         break;
//     case (SURESTE):
//         pos_min = Posicion((this->tablero->cantidadFil
//         pos_min = Posicion((this->tablero->cantidadFilas() / 2) + 1, 1);
// /as() / 2) + 1, (this->tablero->cantidadColumnas() / 2) + 1);
